      ...
      <div className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-4 py-14 md:py-20">
          <div className="grid items-center gap-10 md:grid-cols-2">
            ...
            <div className="inline-flex items-center gap-2 rounded-2xl border border-[rgba(210,19,21,0.25)] bg-[rgba(210,19,21,0.12)] px-4 py-2 text-sm font-extrabold text-[var(--brand)] shadow-sm md:px-5 md:py-2.5 md:text-base">
  <span className="inline-flex h-2.5 w-2.5 rounded-full bg-[var(--brand)] motion-safe:animate-pulse" />
